...
$sql ="INSERT INTO users(name,email, password, gender, mobile, designation, image, status) VALUES(:name, :email, AES_ENCRYPT(:password, 'zhwr2Ie8+AeJSKB2KKIya4KIO3FaYaxKo8MCUFSTcW0='), :gender, :mobileno, :designation, :image, 1)";
